...
def main():
    ...
    w = wayp0.setWaypoints(3,16,True,True,0.0,0.0,0.0,float('nan'),47.3978004456,8.54558086395,50)
    wps.append(w)

    w = wayp1.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),47.397808075,8.54568386078,50)
    wps.append(w)

    w = wayp2.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),47.3977279663,8.54573154449,50)
    wps.append(w)

    w = wayp3.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),47.3977012634,8.54556751251,50)
    wps.append(w)

    w = wayp4.setWaypoints(3,16,False,True,0.0,0.0,0.0,float('nan'),47.3977890015,8.54557132721,50)
    wps.append(w)
